...
public class TyreTypePreTest {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testConstructor1u() {
		new TyreType("185/65 R15",-1,0);
	}
	@Test(expected = IllegalArgumentException.class)
	public void testConstructor1z() {
		new TyreType("185/65 R15",4,0);
	}
	@Test(expected = IllegalArgumentException.class)
	public void testConstructor190() {
		new TyreType("185/65 R15",4,-2);
	}
