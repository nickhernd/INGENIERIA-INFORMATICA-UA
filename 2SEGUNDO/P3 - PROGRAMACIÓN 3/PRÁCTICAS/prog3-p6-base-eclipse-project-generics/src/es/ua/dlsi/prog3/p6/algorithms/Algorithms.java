...
public class Algorithms {
	 ...
	 */
	public static int shortestPathCost(Graph graph, Node fromNode, Node toNode, ICostOperators<?> a) throws NodeNotFoundException, GraphAlgorithmException {
		DijkstraShortestPath dijkstraShortestPath = new DijkstraShortestPath(graph, a);
		...
		Integer distance = (Integer) dijkstraShortestPath.getComputedDistances().get(toNode);
		if (distance == null) {
